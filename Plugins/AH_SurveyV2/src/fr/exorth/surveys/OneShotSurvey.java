...
public class OneShotSurvey implements Survey{
	...
	public OneShotSurvey(String name, String displayName) {
	...
	public OneShotSurvey(String name) {
		
		this.name=name;
		
	}
	
	public OneShotSurvey() {}
	
	public OneShotSurvey(String name, String displayName, ArrayList<Question> questions, boolean visibility) {
	...
	public OneShotSurvey getSurvey(String name){
		...
		boolean visibility = (boolean) cfg.get("Visibility");
		...
		OneShotSurvey sv = new OneShotSurvey(name,dName,questions,visibility);
	...
	public void completeSurvey(){
		...
		if(!SurveyMain.getInstance().ConfigManagers.containsKey(name)){
			SurveyConfigManager cfgm = new SurveyConfigManager("ONESHOT",name);
		...
		SurveyUtils.saveSurvey(name,"ONESHOT");
