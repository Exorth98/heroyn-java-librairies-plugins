...
public class FTConfigManager {
	...
	private FactionTuto plugin = FactionTuto.getPlugin(FactionTuto.class);
	...
	public FTConfigManager(String fileName) {
	...
	public void setupCustomConfig() {
		...
		file = new File(plugin.getDataFolder(),  "Tutos/"+fileName+".yml");
