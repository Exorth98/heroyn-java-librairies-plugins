...
public enum Particles
{
  ...
  static
  {
    ...
    ID_MAP = new HashMap<>();
    Particles[] arrayOfParticles;
    int j = (arrayOfParticles = values()).length;
    for (int i = 0; i < j; i++)
    {
      Particles effect = arrayOfParticles[i];
  ...
  public static final class ItemData
    extends Particles.ParticleData
  {
  ...
  public static final class OrdinaryColor
    extends Particles.ParticleColor
  {
      ...
      try
      {
        ...
        else
        {
          ...
          if (this.data != null)
          {
            ...
            ReflectionUtils.setValue(this.packet, true, "k", new int[] { this.effect == Particles.ITEM_CRACK ? packetData[1] : packetData[0] | packetData[1] << 12 });
          }
        }
